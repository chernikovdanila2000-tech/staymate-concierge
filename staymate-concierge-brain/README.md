...
| Viber | ✅ Код готовий і захищений підписом webhook; перше підключення безпечно проходить перевірку Viber. Живий тест очікує токен бота |
| WhatsApp | ✅ Живий text E2E підтверджений; голосові повідомлення готові в коді та очікують ключ розпізнавання |
| Instagram | ✅ Живий text і voice E2E підтверджений: Direct → розпізнавання → AI → відповідь |
| Messenger | ⚠️ Код і regression-перевірки готові, але production Page Access Token відхилений Meta (HTTP 401); потрібне його оновлення перед живим тестом |
| Голосові повідомлення | ✅ Instagram voice E2E підтверджений. Telegram і WhatsApp використовують той самий безпечний потік аудіо → розпізнавання → AI → відповідь; Viber не позначено як голосовий канал, бо його Bot API не заявляє такий вхідний тип. |
